...
public class AnsiToHtmlProcessor extends AnsiProcessor {
    ...
    private final List<AnsiAttributeElement> openTags;

    private String currentForegroundColor = null;
    private String currentBackgroundColor = null;
    private boolean swapColors = false;
    private boolean writingEnabled = true;


    public AnsiToHtmlProcessor(OutputStream os, AnsiColorMap colorMap, AnsiAttributeElement.Emitter emitter, List<AnsiAttributeElement> openTags) {
        super(os);
    ...
    public void initTags() {
        final List<AnsiAttributeElement> tagsToOpen = new ArrayList<>(openTags);
        openTags.clear();
        ...
        tagsToOpen.forEach(this::openTag);
    }
    ...
    private String getDefaultBackgroundColor() {
        ...
        if (defaultBgIndex != null) {
            color = colorMap.getNormal(defaultBgIndex);
        }
        if (color == null) {
    ...
    private String getDefaultForegroundColor() {
        ...
        if (defaultFgIndex != null) {
            color = colorMap.getNormal(defaultFgIndex);
        }
        if (color == null) {
            color = "currentColor";
        }
